...
function GoodMorning() {
  ...
  const tts = [
    "어깨넓이로 서서 무릎을 약간 굽히고 시선은 정면을 향합니다.",
    "잘하고 있어요",
    "거의 다 왔어요",
    "완료!",
  ]
  ...
  useEffect(() => {
    ...
    let time = setTimeout(() => {
      setCam(!cam)
      let audioTune = new Audio("/TTS/goodmorning.mp3")
      audioTune.play()
    }, 10000)
    ...
    <>
      <div className={cam ? "display" : "displayNone"}>
        <div className="exerImg">
          <img src="/img/goodmorning1.jpg" alt="" />
          <div className="tts">
        ...
        <div className="canvasCenter">
          ...
          <div className="hiddenImg">
            <img src="/img/transparentsGoodmoring.png" alt="" />
          </div>
        </div>
      </div>
...
export default withRouter(GoodMorning)
